...
def testRegisterCompetitors():
    ...
    # get both of our current tournament ids and assign them to variables we
    # can pass on to additional test functions
...
def testPlayRounds(t_id):
    ...
    # Use random numbers to decide the outcomes of each match in this
    # tournament and outputs the results
    ...
    for row in currentStandings:
        ...
        # This just helps us keep the table aligned for easy browsing
